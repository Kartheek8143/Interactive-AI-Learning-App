          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              <input
                ...
                autoComplete="off"
                style={{ width: '100%', padding: '13px 16px', borderRadius: '12px', background: 'rgba(255,255,255,0.04)', border: `1.5px solid ${key && isValidKey() ? provider.color + '60' : 'rgba(255,255,255,0.1)'}`, color: '#f0f4ff', fontSize: '13px', fontFamily: 'monospace', boxSizing: 'border-box', outline: 'none', transition: 'border 0.2s' }}
              />
              {key && (
