        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <button
            ...
            style={{
              ...
              background: apiKey ? 'rgba(16,185,129,0.15)' : 'rgba(124,58,237,0.15)',
              color: apiKey ? '#10b981' : '#a78bfa',
              border: `1px solid ${apiKey ? 'rgba(16,185,129,0.3)' : 'rgba(124,58,237,0.3)'}`,
              transition: 'all 0.2s',
            }}
          >
            <span>
              {!apiKey ? '🔑' :
               (apiKey.trim().toLowerCase() === 'ollama' || apiKey.trim().startsWith('http://localhost')) ? '🦙' :
